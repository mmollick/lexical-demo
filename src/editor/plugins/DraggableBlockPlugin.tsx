 ...
 *
 */
// Adapted from https://github.com/facebook/lexical/blob/main/packages/lexical-playground/src/plugins/DraggableBlockPlugin/index.tsx
...
const DraggableBlockMenu = React.forwardRef<
  HTMLDivElement,
...
>((props, ref) => (
  <div
    ref={ref}
    {...props}
    className="absolute top-0 left-0 cursor-grab rounded-sm px-px py-0.5 opacity-0 [will-change:transform] hover:bg-muted active:cursor-grabbing"
  />
));
DraggableBlockMenu.displayName = 'DraggableBlockMenu';
